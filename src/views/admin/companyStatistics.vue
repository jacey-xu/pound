    ...
    <div class="app-container calendar-list-container">
        <div class="filter-container">
            <el-row>
                ...
                <el-col :span="20">
                    <el-input @keyup.enter.native="handleFilter" style="width: 200px;" class="filter-item" placeholder="公司" v-model="listQuery.commodityName"></el-input>
                    <el-date-picker
                            v-model="datetimes"
                            type="daterange"
                            range-separator="-"
...
<!--                <el-col :span="2">
        ...
        <el-table id="tbid" :data="list"  :summary-method="getSummaries" show-summary v-loading.body="listLoading" border fit highlight-current-row style="width: 98%">
            ...
            <el-table-column  align="center" label="客户公司" prop="companyName">
            ...
            <el-table-column  align="center" label="职位" prop="position">
                <template slot-scope="scope"><span>{{scope.row.position}}</span></template>
            </el-table-column>
            <el-table-column  align="center" label="手机" prop="mobile">
                <template slot-scope="scope"><span>{{scope.row.mobile}}</span></template>
            </el-table-column>
            <el-table-column  align="center" label="证件号" prop="identity_card">
                <template slot-scope="scope"><span>{{scope.row.identity_card}}</span></template>
            </el-table-column>
...
<!--            <el-table-column  align="center" label="货品数量" prop="num">
            ...
            <el-table-column  align="center" label="充值金额(元)" prop="salesPrice">
                          ...
                          let items = [
                              {
                                  ...
                                  "identity_card":'320423456784837213',
                                  "time":'2018-01-18',
                                  "nickname":'张三',
                                  "position":'司机',
                                  "mobile":'18112345678',
