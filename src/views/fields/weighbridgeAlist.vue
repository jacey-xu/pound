<template>
    <div class="app-container calendar-list-container">
        ...
        <el-table id="tbid" :data="list"  v-loading.body="listLoading" border fit highlight-current-row style="width: 98%">
            ...
            <el-table-column  align="center" label="出场时间" prop="outTime">
        ...
        <el-button type="success" plain @click="handleDownload()" size="small" style="float: right;
    margin-top: 15px;">打印全部</el-button>
